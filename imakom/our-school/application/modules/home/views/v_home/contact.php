    ...
    <!-- ##### Contact Area Start ##### -->
    <section class="contact-area"  style="background-image: url(<?= base_url() ?>theme/clever/img/core-img/texture.png);" >
        <div class="container">
            <div class="row">
                <!-- Contact Info -->
                    ...
                    <div class="contact--info mt-50 mb-50">
                        ...
                        <?php echo form_open('contact', '', 'hidden'); ?>
                            <div class="row">
                                ...
                                <!-- <?= get_csrf(); ?> -->
                                <div class="col-12">
                                    <button class="btn clever-btn w-100" type="submit" style="color:black; top:-5px">Kirim</button>
                                </div>
                            </div>
                        <!-- </form> -->
                        <?php echo form_close(); ?>
