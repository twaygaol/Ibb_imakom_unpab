<!-- ##### Regular Page Area Start ##### -->
    ...
    <h3 class="fw-black">AGENDA TERBARU  <img src="<?= base_url('asset/img/anggota/logo imakom.png') ?>"  width="70" height="70"  alt=""> <img src="<?= base_url('asset/img/anggota/logo pancabudi.png') ?>" width="70" height="70" alt=""></h3>
