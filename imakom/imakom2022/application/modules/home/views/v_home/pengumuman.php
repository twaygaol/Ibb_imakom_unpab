<!-- ##### Regular Page Area Start ##### -->
    ...
    <h3 class="fw-black">PENGUMUMAN  <img src="<?= base_url('asset/img/anggota/logo imakom.png') ?>"  width="70" height="70"  alt=""> <img src="<?= base_url('asset/img/anggota/logo pancabudi.png') ?>" width="70" height="70" alt=""></h3>
                ...
                <?php foreach ($pengumuman as $pengumuman): ?>
                    ...
                    <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="date-fee d-flex justify-content-between">
                            <div class="date">
                                <p><i class="fa fa-clock"></i> admin <?= date('d/m/Y',strtotime($pengumuman['created_at'])) ?></p>
                            </div>
